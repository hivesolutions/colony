...
def main():
    ...
    prefix_path + "pt.hive.colony.plugins.data_converter.intermediate_structure/src/colony/plugins;" +\
    prefix_path + "pt.hive.colony.plugins.data_converter.intermediate_structure.io_adapter.csv/src/colony/plugins;" +\
