...
__revision__ = "$LastChangedRevision: 2141 $"
""" The revision number of the module """

__date__ = "$LastChangedDate: 2008-10-21 19:06:49 +0100 (Ter, 21 Out 2008) $"
...
def main():
    ...
    prefix_path + "pt.hive.colony.plugins.fuse/src/colony/plugins;" +\
    prefix_path + "pt.hive.colony.plugins.gui.diamante/src/colony/plugins;" +\
    prefix_path + "pt.hive.colony.plugins.hivefs/src/colony/plugins;" +\
