...
plugin_path_list = ["plugins",
                    ...
                    "%panzerini_path%/pt.hive.panzerini.plugins.main.logic/src/panzerini/plugins",
                    "%panzerini_path%/pt.hive.panzerini.plugins.main.websocket_handler/src/panzerini/plugins",
