...
plugin_path_list = [
    ...
    "%colony_configuration_prefix_path%/pt.hive.colony.configuration.plugins.all/src/colony/plugins",
    "%colony_configuration_prefix_path%/pt.hive.colony.configuration.plugins.development/src/colony/plugins",
    "%colony_language_prefix_path%/pt.hive.colony.language.plugins.generator/src/colony/plugins",
    ...
    "%colony_prefix_path%/pt.hive.colony.plugins.main.client.mdns/src/colony/plugins",
    ...
    "%omni_prefix_path%/pt.hive.omni.plugins.inventory/src/omni/plugins",
    ...
    "%omni_prefix_path%/pt.hive.omni.plugins.purchases/src/omni/plugins",
    ...
    "%omni_prefix_path%/pt.hive.omni.plugins.web_pum/src/omni/plugins",
    "%omni_prefix_path%/pt.hive.omni.plugins.web_sam/src/omni/plugins",
