...
plugin_path_list = [
    ...
    "%omni_prefix_path%/pt.hive.omni.plugins.web_im/src/omni/plugins",
    ...
    "%take_the_bill_site_prefix_path%/pt.hive.take_the_bill_site.plugins.main/src/take_the_bill_site/plugins",
