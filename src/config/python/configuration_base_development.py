...
plugin_path_list = [
    ...
    "%colony_extras_prefix_path%/pt.hive.colony.bundles.plugins.configuration.bundles/src/colony/plugins",
    ...
    "%colony_configuration_prefix_path%/pt.hive.colony.configuration.plugins.extras/src/colony/plugins",
    "%colony_configuration_prefix_path%/pt.hive.colony.configuration.plugins.production/src/colony/plugins",
    "%colony_configuration_prefix_path%/pt.hive.colony.configuration.plugins.test/src/colony/plugins",
    ...
    "%colony_prefix_path%/pt.hive.colony.plugins.samples.mvc/src/colony/plugins",
    ...
    "%colony_prefix_path%/pt.hive.colony.plugins.service.dropbox/src/colony/plugins",
    ...
    "%colony_prefix_path%/pt.hive.colony.plugins.service.paypal/src/colony/plugins",
    ...
    "%colony_documentation_prefix_path%/pt.hive.colony.documentation.plugins.technical/src/colony_documentation/plugins",
    "%colony_site_prefix_path%/pt.hive.colony_site.plugins.main/src/colony_site/plugins",
    "%frontdoor_site_prefix_path%/pt.hive.frontdoor_site.plugins.main/src/frontdoor_site/plugins",
    "%omni_extras_prefix_path%/pt.hive.omni.bundles.plugins.configuration.bundles/src/omni/plugins",
    "%omni_configuration_prefix_path%/pt.hive.omni.configuration.plugins.all/src/omni/plugins",
    "%omni_configuration_prefix_path%/pt.hive.omni.configuration.plugins.extras/src/omni/plugins",
    "%omni_prefix_path%/pt.hive.omni.plugins.analytics/src/omni/plugins",
    ...
    "%omni_prefix_path%/pt.hive.omni.plugins.extras/src/omni/plugins",
    ...
    "%omni_prefix_path%/pt.hive.omni.plugins.web_error/src/omni/plugins",
    "%omni_prefix_path%/pt.hive.omni.plugins.web_doc/src/omni/plugins",
    "%omni_prefix_path%/pt.hive.omni.plugins.web_ivm/src/omni/plugins",
    "%omni_prefix_path%/pt.hive.omni.plugins.web_pos/src/omni/plugins",
    ...
    "%omni_prefix_path%/pt.hive.omni.plugins.web_util/src/omni/plugins",
    "%omni_data_prefix_path%/pt.hive.omni.data.plugins.development/src/omni/plugins",
    ...
    "%products_configuration_prefix_path%/pt.hive.products.configuration.plugins.production/src/products/plugins",
    ...
    "%ustore_configuration_prefix_path%/pt.hive.ustore.configuration.plugins.development/src/ustore/plugins",
    "%ustore_prefix_path%/pt.hive.ustore.plugins.main/src/ustore/plugins",
