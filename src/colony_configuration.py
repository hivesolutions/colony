...
plugin_path_list = ["colony/plugins",
                    ...
                    "%colony_prefix_path%/pt.hive.colony.plugins.business.access_control/src/colony/plugins",
                    "%colony_prefix_path%/pt.hive.colony.plugins.business.data/src/colony/plugins",
                    ...
                    "%colony_prefix_path%/pt.hive.colony.plugins.eureka/src/colony/plugins",
                    "%colony_prefix_path%/pt.hive.colony.plugins.eureka.mocks/src/colony/plugins",
                    ...
                    "%colony_prefix_path%/pt.hive.colony.plugins.localization/src/colony/plugins",
                    ...
                    "%colony_prefix_path%/pt.hive.colony.plugins.main.login/src/colony/plugins",
                    ...
                    "%colony_prefix_path%/pt.hive.colony.plugins.main.remote.client.pyro/src/colony/plugins",
                    "%colony_prefix_path%/pt.hive.colony.plugins.main.remote.client.soap/src/colony/plugins",
                    ...
                    "%colony_prefix_path%/pt.hive.colony.plugins.main.remote.pyro/src/colony/plugins",
                    "%colony_prefix_path%/pt.hive.colony.plugins.main.remote.soap/src/colony/plugins",
                    ...
                    "%colony_prefix_path%/pt.hive.colony.plugins.main.web/src/colony/plugins",
                    ...
                    "%colony_prefix_path%/pt.hive.colony.plugins.template.administration/src/colony/plugins",
                    ...
                    "%omni_prefix_path%/pt.hive.omni.plugins.pos.logic/src/omni/plugins",
