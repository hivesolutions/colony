...
plugin_path_list = ["colony/plugins",
                    ...
                    "%prefix_path%/pt.hive.colony.plugins.main.authentication/src/colony/plugins",
                    "%prefix_path%/pt.hive.colony.plugins.main.authentication.logic/src/colony/plugins",
                    "%prefix_path%/pt.hive.colony.plugins.main.client.ldap/src/colony/plugins",
